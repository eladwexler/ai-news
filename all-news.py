...
import feedparser
import requests
# Import urllib3 to suppress the SSL warnings we are about to bypass
import urllib3

# Suppress the "InsecureRequestWarning" alerts from flooding your terminal
...
def fetch_daily_ai_news():
    ...
    for source_name, url in FEEDS.items():
        ...
        try:
            # ADDED: verify=False tells Python to ignore the self-signed proxy certificate
            ...
            print(f"  [Success] Saved {article_count} articles.")
